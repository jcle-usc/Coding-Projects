...
public class BlockS extends JPanel implements Block
{
    ...
    public BlockS(JPanel tetris, Tetris tet)
    {
        ...
        switch (rotate)
        {
            case 0:
                for (int i = 0; i < 2; i++)
                {
                    ...
                    g.fillRect((i * 35) + 35,0,35,35);
                    g.setColor(new Color(0, 0, 0));
                    g.drawRect((i * 35) + 35,0,35,35);
                }
                for (int i = 0; i < 2; i++)
                {
                    g.setColor(new Color(0, 255, 0));
            ...
            case 1:
                ...
                {
                    g.setColor(new Color(0, 255, 0));
                    g.fillRect(35,(i * 35) + 35,35,35);
                    g.setColor(new Color(0, 0, 0));
                    g.drawRect(35,(i * 35) + 35,35,35);
                }
                break;
            case 2:
                for (int i = 0; i < 2; i++)
