...
public class BlockL extends JPanel implements Block
{
    ...
    public BlockL(JPanel tetris, Tetris tet)
    {
    ...
    protected void paintComponent(Graphics graphic)
    {
        ...
        switch (rotate)
        {
            ...
            case 1:
                g.setColor(new Color(255, 200, 0));
                g.fillRect(35,70,35,35);
                g.setColor(new Color(0, 0, 0));
                g.drawRect(35,70,35,35);
                for (int i = 0; i < 3; i++)
                {
                    g.setColor(new Color(255, 200, 0));
            ...
            case 2:
                g.setColor(new Color(255, 200, 0));
                g.fillRect(0,35,35,35);
                g.setColor(new Color(0, 0, 0));
                g.drawRect(0,35,35,35);
                for (int i = 0; i < 3; i++)
                {
                    g.setColor(new Color(255, 200, 0));
