...
public class BlockZ extends JPanel implements Block
{
    ...
    public BlockZ(JPanel tetris, Tetris tet)
    {
    ...
    protected void paintComponent(Graphics graphic)
    {
        ...
        switch (rotate)
        {
            case 0:
                ...
                {
                    g.setColor(new Color(255, 0, 0));
                    g.fillRect((i * 35) + 35,35,35,35);
                    g.setColor(new Color(0, 0, 0));
                    g.drawRect((i * 35) + 35,35,35,35);
                }
                break;
            case 1:
                for (int i = 0; i < 2; i++)
                {
                    g.setColor(new Color(255, 0, 0));
                    g.fillRect(0,(i * 35) + 35,35,35);
                    g.setColor(new Color(0, 0, 0));
                    g.drawRect(0,(i * 35) + 35,35,35);
                }
                for (int i = 0; i < 2; i++)
                {
                    g.setColor(new Color(255, 0, 0));
